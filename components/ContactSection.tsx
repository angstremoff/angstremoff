...
export default function ContactSection() {
  ...
  const contactInfo = [
    ...
    },
    {
      ...
      content: t.contact.emailAddressContent,
    }
  ];
  ...
  return (
    <section id="contact" className="py-20 md:py-28 relative overflow-hidden">
      ...
      <div className="absolute -bottom-24 -right-24 w-64 h-64 bg-[#9C27B0]/10 rounded-full blur-3xl opacity-50"></div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          >
            <div className="bg-white/5 rounded-xl p-8 border border-white/10 h-full">
              ...
              <h4 className="text-lg font-semibold mb-4">{t.footer.socialLinks}</h4>
              <div className="flex space-x-4">
                <a href="#" className="w-10 h-10 rounded-full bg-white/10 flex items-center justify-center text-white hover:bg-accent/80 transition-colors">
            ...
            <div className="bg-white/5 rounded-xl p-8 border border-white/10">
              ...
              {isSubmitted ? (
                <motion.div 
                  ...
                  className="p-6 bg-accent/20 rounded-xl text-center"
                >
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-12 h-12 mx-auto mb-4 text-accent">
                    <path strokeLinecap="round" strokeLinejoin="round" d="M9 12.75 11.25 15 15 9.75M21 12a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z" />
                  </svg>
                  <h4 className="text-xl font-bold mb-2">{t.contact.messageSent}</h4>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <button
                    ...
                    className={`w-full px-6 py-3 bg-accent text-white rounded-full font-medium transition-all hover:bg-accent/90 ${
