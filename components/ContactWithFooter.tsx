                  ...
                  <div className="space-y-8">
                    ...
                    <div className="flex items-start">
                      ...
                      <div>
                        ...
                        <p className="text-white">{t.contact.phoneContent}</p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start">
                      ...
                      <div>
                        ...
                        <p className="text-white">{t.contact.telegramContent}</p>
                      </div>
                    </div>
                  </div>
                </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-10">
            <div className="md:col-span-1">
              ...
              <div className="flex space-x-3">
                ...
                <a href="tel:+38164183448" className="w-9 h-9 rounded-full bg-white/5 flex items-center justify-center text-white hover:bg-accent/80 transition-colors">
                  <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor" viewBox="0 0 16 16">
                    <path d="M2 3a1 1 0 011-1h2.153a1 1 0 01.986.836l.74 4.435a1 1 0 01-.54 1.06l-1.548.773a11.037 11.037 0 006.105 6.105l.774-1.548a1 1 0 011.059-.54l4.435.74a1 1 0 01.836.986V17a1 1 0 01-1 1h-2C7.82 18 2 12.18 2 5V3z" />
                  </svg>
                </a>
            ...
            <div className="md:col-span-1">
              ...
              <ul className="space-y-4">
                ...
                <li className="flex items-start">
                  ...
                  <span className="text-gray-400"><span data-noindex="true">{t.footer.phone}</span></span>
                </li>
                <li className="flex items-start">
                  <span className="mr-3 mt-1 text-accent"><svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                    <path d="M2.003 5.884L10 9.882l7.997-3.998A2 2 0 0016 4H4a2 2 0 00-1.997 1.884z" />
